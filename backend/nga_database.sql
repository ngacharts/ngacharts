...
SELECT 
  ...
  FLOOR(ABS(pne.longitude)) + (FLOOR((ABS(pne.longitude) - FLOOR(ABS(pne.longitude))) * 60) + ROUND((ABS(pne.longitude) - FLOOR(ABS(pne.longitude)) - FLOOR((ABS(pne.longitude) - FLOOR(ABS(pne.longitude))) * 60) / 60) * 3600) DIV 60) DIV 60 AS Edeg, (FLOOR((ABS(pne.longitude) - FLOOR(ABS(pne.longitude))) * 60) + ROUND((ABS(pne.longitude) - FLOOR(ABS(pne.longitude)) - FLOOR((ABS(pne.longitude) - FLOOR(ABS(pne.longitude))) * 60) / 60) * 3600) DIV 60) % 60 AS Emin, ROUND((ABS(pne.longitude) - FLOOR(ABS(pne.longitude)) - FLOOR((ABS(pne.longitude) - FLOOR(ABS(pne.longitude))) * 60) / 60) * 3600) % 60 AS Esec, IF(pne.longitude IS NULL, NULL, (IF pne.longitude >= 0, 'E', 'W')) AS Eehemi,
  
  FLOOR(ABS(psw.longitude)) + (FLOOR((ABS(psw.longitude) - FLOOR(ABS(psw.longitude))) * 60) + ROUND((ABS(psw.longitude) - FLOOR(ABS(psw.longitude)) - FLOOR((ABS(psw.longitude) - FLOOR(ABS(psw.longitude))) * 60) / 60) * 3600) DIV 60) DIV 60 AS Wdeg, (FLOOR((ABS(psw.longitude) - FLOOR(ABS(psw.longitude))) * 60) + ROUND((ABS(psw.longitude) - FLOOR(ABS(psw.longitude)) - FLOOR((ABS(psw.longitude) - FLOOR(ABS(psw.longitude))) * 60) / 60) * 3600) DIV 60) % 60 AS Wmin, ROUND((ABS(psw.longitude) - FLOOR(ABS(psw.longitude)) - FLOOR((ABS(psw.longitude) - FLOOR(ABS(psw.longitude))) * 60) / 60) * 3600) % 60 AS Wsec, IF(psw.longitude IS NULL, NULL, (IF psw.longitude >= 0, 'E', 'W')) AS Wehemi,
